...
Valuta interfacce e progettazione visiva.

## Scopo

Migliorare layout, usabilità, gerarchie visive e flussi.
...
```yaml
quando_usarlo:
  - "quando il task rientra negli ambiti: web-design, grafica"
...
```yaml
funzioni_usate: ['analizza_ui', 'propone_layout', 'controlla_usabilita']
```
