...
Analizza dati e documenti lavorativi.

## Scopo

Interpretare buste paga, contratti, mansioni e turni.
...
```yaml
quando_usarlo:
  - "quando il task rientra negli ambiti: lavoro, finanza, salute"
...
```yaml
ambiti:
  principali: ['lavoro', 'finanza', 'salute']
  intersecabili:
    - "documenti"
    - "ricerca"
    - "automazione"
...
```yaml
funzioni_usate: ['analizza_busta_paga', 'classifica_dati_lavoro']
```
