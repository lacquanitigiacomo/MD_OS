...
L'orchestratore coordina l'intero framework.

## Scopo

Decidere quali moduli, agenti, funzioni, schemi e output usare.
...
```yaml
funzioni_usate: ['rileva_ambiente', 'ricostruisci_struttura', 'seleziona_agente', 'seleziona_output']
```
