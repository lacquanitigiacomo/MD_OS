...
Il revisore controlla qualità e coerenza.

## Scopo

Individuare errori, mancanze, contraddizioni e ridondanze.
...
```yaml
quando_usarlo:
  - "quando il task rientra negli ambiti: documenti, codice, progettazione-framework"
...
```yaml
ambiti:
  principali: ['documenti', 'codice', 'progettazione-framework']
  intersecabili:
    - "documenti"
    - "ricerca"
    - "automazione"
...
```yaml
funzioni_usate: ['controlla_coerenza', 'verifica_completezza', 'rileva_ridondanze']
```
