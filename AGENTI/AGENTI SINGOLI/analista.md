...
L'analista interpreta richieste, dati e contesto.

## Scopo

Trasformare una richiesta grezza in una struttura chiara.
...
```yaml
quando_usarlo:
  - "quando il task rientra negli ambiti: documenti, lavoro, finanza, ricerca"
...
```yaml
ambiti:
  principali: ['documenti', 'lavoro', 'finanza', 'ricerca']
  intersecabili:
    - "documenti"
    - "ricerca"
    - "automazione"
...
```yaml
funzioni_usate: ['analizza_richiesta', 'classifica_complessita', 'estrai_dati']
```
