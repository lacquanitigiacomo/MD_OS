...
Gestisce continuità e aggiornamenti del framework.

## Scopo

Produrre patch, changelog e aggiornamenti modulari.
...
```yaml
quando_usarlo:
  - "quando il task rientra negli ambiti: progettazione-framework, documenti"
...
```yaml
ambiti:
  principali: ['progettazione-framework', 'documenti']
  intersecabili:
    - "documenti"
    - "ricerca"
    - "automazione"
...
```yaml
funzioni_usate: ['crea_patch', 'aggiorna_modulo', 'genera_changelog']
```
