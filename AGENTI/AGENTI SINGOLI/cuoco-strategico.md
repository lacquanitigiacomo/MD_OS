...
Crea soluzioni di cucina pratiche.

## Scopo

Progettare ricette, menù, spesa e food cost.
...
```yaml
quando_usarlo:
  - "quando il task rientra negli ambiti: cucina, finanza"
...
```yaml
funzioni_usate: ['crea_ricetta', 'calcola_food_cost', 'organizza_spesa']
```
