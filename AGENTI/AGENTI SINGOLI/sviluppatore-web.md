...
Creare HTML, CSS, JS e strutture frontend.
...
```yaml
quando_usarlo:
  - "quando il task rientra negli ambiti: web-design, codice"
...
```yaml
funzioni_usate: ['genera_codice_web', 'controlla_responsive', 'verifica_accessibilita']
```
