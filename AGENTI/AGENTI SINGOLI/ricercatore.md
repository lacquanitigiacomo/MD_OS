...
Il ricercatore raccoglie e organizza informazioni.

## Scopo

Verificare, confrontare e sintetizzare informazioni.
...
```yaml
quando_usarlo:
  - "quando il task rientra negli ambiti: ricerca, documenti, lavoro"
...
```yaml
ambiti:
  principali: ['ricerca', 'documenti', 'lavoro']
  intersecabili:
    - "documenti"
    - "ricerca"
    - "automazione"
...
```yaml
funzioni_usate: ['cerca_fonti', 'verifica_aggiornamento', 'sintetizza_fonti']
```
