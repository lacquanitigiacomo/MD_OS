...
descrizione_breve: Ambito operativo diritto normativa.
trigger: ['contratti', 'privacy_gdpr', 'compliance', 'normativa', 'diritto_lavoro']
tag: ['contratti', 'privacy_gdpr', 'compliance', 'normativa', 'diritto_lavoro']
...
## 1. Identità ambito
Ambito dedicato a diritto normativa.

## 2. Scopo
Orientare discovery, selezione agenti, dataset e output per le sottoaree collegate.

## 3. Perimetro operativo
Sottoaree: contratti, privacy_gdpr, compliance, normativa, diritto_lavoro.
