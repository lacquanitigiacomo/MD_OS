---
id_agente: revisore_contabile
nome: Revisore Contabile
...
trigger: ['contabilita', 'fiscalita', 'budget_controllo', 'revisore', 'contabile']
tag: ['contabilita', 'fiscalita', 'budget_controllo', 'revisore', 'contabile']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: contabilita, fiscalita, budget_controllo, revisore, contabile.
- Quando serve competenza da Revisore Contabile.
...
| revisore | riconoscimento e routing |
| contabile | riconoscimento e routing |
