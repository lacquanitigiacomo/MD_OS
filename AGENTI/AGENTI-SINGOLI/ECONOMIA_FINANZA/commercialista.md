...
trigger: ['contabilita', 'fiscalita', 'budget_controllo', 'commercialista']
tag: ['contabilita', 'fiscalita', 'budget_controllo', 'commercialista']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: contabilita, fiscalita, budget_controllo, commercialista.
- Quando serve competenza da Commercialista.
...
| commercialista | riconoscimento e routing |
