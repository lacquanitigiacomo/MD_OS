...
tag: ['contabilita', 'fiscalita', 'budget_controllo', 'tax', 'advisor']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: contabilita, fiscalita, budget_controllo, tax, advisor.
...
| tax | riconoscimento e routing |
| advisor | riconoscimento e routing |
