...
trigger: ['benessere', 'nutrizione', 'psicologia_supporto', 'ergonomo']
tag: ['benessere', 'nutrizione', 'psicologia_supporto', 'ergonomo']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: benessere, nutrizione, psicologia_supporto, ergonomo.
- Quando serve competenza da Ergonomo.
...
| ergonomo | riconoscimento e routing |
