---
id_agente: prevenzione_benessere
nome: Prevenzione Benessere
professione: Prevenzione Benessere
...
trigger: ['benessere', 'nutrizione', 'psicologia_supporto', 'prevenzione', 'benessere']
tag: ['benessere', 'nutrizione', 'psicologia_supporto', 'prevenzione', 'benessere']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: benessere, nutrizione, psicologia_supporto, prevenzione, benessere.
- Quando serve competenza da Prevenzione Benessere.
...
| prevenzione | riconoscimento e routing |
| benessere | riconoscimento e routing |
