---
id_agente: meal_planner
nome: Meal Planner
professione: Meal Planner
...
trigger: ['cucina', 'manutenzione_casa', 'organizzazione', 'meal', 'planner']
tag: ['cucina', 'manutenzione_casa', 'organizzazione', 'meal', 'planner']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: cucina, manutenzione_casa, organizzazione, meal, planner.
- Quando serve competenza da Meal Planner.
