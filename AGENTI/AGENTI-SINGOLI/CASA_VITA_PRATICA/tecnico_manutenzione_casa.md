...
trigger: ['cucina', 'manutenzione_domestica', 'organizzazione_casa', 'tecnico', 'manutenzione']
tag: ['cucina', 'manutenzione_domestica', 'organizzazione_casa']
output:
  - analisi
  - checklist
  - patch
...
Agente specializzato nell'ambito `CASA_VITA_PRATICA` con focus su: cucina, manutenzione_domestica, organizzazione_casa.
...
## 6. Quando attivarlo
- Quando la richiesta contiene trigger collegati a cucina, manutenzione_domestica, organizzazione_casa.
...
| Tag | Uso |
|---|---|
| cucina | contesto principale |
| manutenzione_domestica | sottoarea |
| organizzazione_casa | specializzazione |
