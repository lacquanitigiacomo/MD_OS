---
id_agente: chef_domestico
nome: Chef Domestico
professione: Chef Domestico
...
trigger: ['cucina', 'manutenzione_casa', 'organizzazione', 'chef', 'domestico']
tag: ['cucina', 'manutenzione_casa', 'organizzazione', 'chef', 'domestico']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: cucina, manutenzione_casa, organizzazione, chef, domestico.
- Quando serve competenza da Chef Domestico.
