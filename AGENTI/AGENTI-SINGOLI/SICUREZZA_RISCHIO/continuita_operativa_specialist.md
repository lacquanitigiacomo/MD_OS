...
trigger: ['risk_management', 'audit', 'data_protection', 'continuita', 'operativa']
tag: ['risk_management', 'audit', 'data_protection', 'continuita', 'operativa']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: risk_management, audit, data_protection, continuita, operativa.
...
| continuita | riconoscimento e routing |
| operativa | riconoscimento e routing |
