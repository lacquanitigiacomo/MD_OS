...
trigger: ['risk_management', 'audit', 'data_protection', 'data', 'protection']
tag: ['risk_management', 'audit', 'data_protection', 'data', 'protection']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: risk_management, audit, data_protection, data, protection.
...
| protection | riconoscimento e routing |
