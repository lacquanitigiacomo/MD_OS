---
id_agente: data_protection_reviewer
nome: Data Protection Reviewer
professione: Data Protection Reviewer
...
trigger: ['sicurezza_fisica', 'emergenze', 'audit_rischio', 'data', 'protection']
...
# Agente — Data Protection Reviewer
...
- Quando serve competenza da data protection reviewer.
