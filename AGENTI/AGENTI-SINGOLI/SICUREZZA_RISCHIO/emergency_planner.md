...
trigger: ['risk_management', 'audit', 'data_protection', 'emergency', 'planner']
tag: ['risk_management', 'audit', 'data_protection', 'emergency', 'planner']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: risk_management, audit, data_protection, emergency, planner.
...
| emergency | riconoscimento e routing |
