...
trigger: ['risk_management', 'audit', 'data_protection', 'risk', 'manager']
tag: ['risk_management', 'audit', 'data_protection', 'risk', 'manager']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: risk_management, audit, data_protection, risk, manager.
