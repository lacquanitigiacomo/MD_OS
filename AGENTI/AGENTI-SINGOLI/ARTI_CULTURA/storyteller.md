...
trigger: ['scrittura', 'critica_culturale', 'storytelling', 'storyteller']
tag: ['scrittura', 'critica_culturale', 'storytelling', 'storyteller']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: scrittura, critica_culturale, storytelling, storyteller.
- Quando serve competenza da Storyteller.
...
| storyteller | riconoscimento e routing |
