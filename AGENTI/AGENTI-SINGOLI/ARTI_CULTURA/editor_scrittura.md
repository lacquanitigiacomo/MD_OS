...
trigger: ['scrittura', 'critica_culturale', 'storytelling', 'editor', 'scrittura']
tag: ['scrittura', 'critica_culturale', 'storytelling', 'editor', 'scrittura']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: scrittura, critica_culturale, storytelling, editor, scrittura.
...
| editor | riconoscimento e routing |
| scrittura | riconoscimento e routing |
