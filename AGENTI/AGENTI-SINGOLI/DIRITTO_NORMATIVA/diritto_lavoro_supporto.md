...
tag: ['contratti', 'privacy_gdpr', 'compliance']
output:
  - analisi
  - checklist
  - patch
...
Agente specializzato nell'ambito `DIRITTO_NORMATIVA` con focus su: contratti, privacy_gdpr, compliance.
...
## 6. Quando attivarlo
- Quando la richiesta contiene trigger collegati a contratti, privacy_gdpr, compliance.
...
| Tag | Uso |
|---|---|
| contratti | contesto principale |
| privacy_gdpr | sottoarea |
| compliance | specializzazione |
...
Richiesta collegata a `contratti`.
