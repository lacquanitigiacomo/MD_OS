...
trigger: ['meccanica', 'elettrica', 'edilizia', 'ingegnere', 'meccanico']
tag: ['meccanica', 'elettrica', 'edilizia']
output:
  - analisi
  - checklist
  - patch
...
Agente specializzato nell'ambito `INDUSTRIA_INGEGNERIA` con focus su: meccanica, elettrica, edilizia.
...
## 6. Quando attivarlo
- Quando la richiesta contiene trigger collegati a meccanica, elettrica, edilizia.
...
| Tag | Uso |
|---|---|
| meccanica | contesto principale |
| elettrica | sottoarea |
| edilizia | specializzazione |
...
Richiesta collegata a `meccanica`.
