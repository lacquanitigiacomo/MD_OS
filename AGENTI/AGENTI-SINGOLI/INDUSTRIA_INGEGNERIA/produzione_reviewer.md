---
id_agente: produzione_reviewer
nome: Produzione Reviewer
professione: Produzione Reviewer
...
trigger: ['meccanica', 'impianti', 'edilizia', 'produzione', 'reviewer']
tag: ['meccanica', 'impianti', 'edilizia', 'produzione', 'reviewer']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: meccanica, impianti, edilizia, produzione, reviewer.
- Quando serve competenza da Produzione Reviewer.
...
| produzione | riconoscimento e routing |
