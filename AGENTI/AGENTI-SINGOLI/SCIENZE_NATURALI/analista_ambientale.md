---
id_agente: analista_ambientale
nome: Analista Ambientale
professione: Analista Ambientale
...
trigger: ['fisica', 'chimica', 'biologia', 'analista', 'ambientale']
tag: ['fisica', 'chimica', 'biologia', 'analista', 'ambientale']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: fisica, chimica, biologia, analista, ambientale.
- Quando serve competenza da Analista Ambientale.
...
| ambientale | riconoscimento e routing |
