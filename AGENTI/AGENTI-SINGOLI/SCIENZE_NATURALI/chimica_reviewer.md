---
id_agente: chimica_reviewer
nome: Chimica Reviewer
professione: Chimica Reviewer
...
trigger: ['fisica', 'chimica', 'biologia', 'chimica', 'reviewer']
tag: ['fisica', 'chimica', 'biologia', 'chimica', 'reviewer']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: fisica, chimica, biologia, chimica, reviewer.
- Quando serve competenza da Chimica Reviewer.
