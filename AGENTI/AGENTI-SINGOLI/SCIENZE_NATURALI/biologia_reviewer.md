---
id_agente: biologia_reviewer
nome: Biologia Reviewer
professione: Biologia Reviewer
...
trigger: ['fisica', 'chimica', 'biologia', 'biologia', 'reviewer']
tag: ['fisica', 'chimica', 'biologia', 'biologia', 'reviewer']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: fisica, chimica, biologia, biologia, reviewer.
- Quando serve competenza da Biologia Reviewer.
