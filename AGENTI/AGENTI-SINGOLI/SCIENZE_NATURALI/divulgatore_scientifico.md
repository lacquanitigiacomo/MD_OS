...
Agente specializzato nell'ambito `SCIENZE_NATURALI` con focus su: fisica, chimica, biologia.
...
## 6. Quando attivarlo
- Quando la richiesta contiene trigger collegati a fisica, chimica, biologia.
...
| Tag | Uso |
|---|---|
| fisica | contesto principale |
| chimica | sottoarea |
| biologia | specializzazione |
