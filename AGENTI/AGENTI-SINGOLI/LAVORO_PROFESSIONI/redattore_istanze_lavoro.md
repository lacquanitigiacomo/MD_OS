...
tag: ['buste_paga_payroll', 'diritto_lavoro', 'ccnl_contratti', 'redattore', 'istanze']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: buste_paga_payroll, diritto_lavoro, ccnl_contratti, redattore, istanze.
...
| istanze | riconoscimento e routing |
