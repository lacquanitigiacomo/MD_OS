...
trigger: ['grafica', 'ui_design', 'ux_research', 'marketing', 'strategist']
tag: ['grafica', 'ui_design', 'ux_research', 'marketing', 'strategist']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: grafica, ui_design, ux_research, marketing, strategist.
...
| marketing | riconoscimento e routing |
