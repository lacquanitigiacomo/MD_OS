...
trigger: ['grafica', 'ui_design', 'ux_research', 'brand', 'designer']
tag: ['grafica', 'ui_design', 'ux_research', 'brand', 'designer']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: grafica, ui_design, ux_research, brand, designer.
...
| brand | riconoscimento e routing |
