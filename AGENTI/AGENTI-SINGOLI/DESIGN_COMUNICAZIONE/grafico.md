...
trigger: ['grafica', 'ui_design', 'ux_research', 'grafico']
tag: ['grafica', 'ui_design', 'ux_research', 'grafico']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: grafica, ui_design, ux_research, grafico.
...
| grafico | riconoscimento e routing |
