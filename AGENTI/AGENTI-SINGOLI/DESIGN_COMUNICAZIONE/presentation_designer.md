...
trigger: ['grafica', 'ui_design', 'ux_research', 'presentation', 'designer']
tag: ['grafica', 'ui_design', 'ux_research', 'presentation', 'designer']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: grafica, ui_design, ux_research, presentation, designer.
...
| presentation | riconoscimento e routing |
