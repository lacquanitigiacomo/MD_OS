...
trigger: ['grafica', 'ui_design', 'ux_research', 'web', 'designer']
tag: ['grafica', 'ui_design', 'ux_research', 'web', 'designer']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: grafica, ui_design, ux_research, web, designer.
