...
trigger: ['grafica', 'ui_design', 'ux_research', 'copywriter']
tag: ['grafica', 'ui_design', 'ux_research', 'copywriter']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: grafica, ui_design, ux_research, copywriter.
...
| copywriter | riconoscimento e routing |
