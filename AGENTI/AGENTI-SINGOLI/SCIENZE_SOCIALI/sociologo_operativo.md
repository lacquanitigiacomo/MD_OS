---
id_agente: sociologo_operativo
nome: Sociologo Operativo
professione: Sociologo Operativo
...
trigger: ['sociologia', 'storia', 'politica', 'sociologo', 'operativo']
tag: ['sociologia', 'storia', 'politica', 'sociologo', 'operativo']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: sociologia, storia, politica, sociologo, operativo.
- Quando serve competenza da Sociologo Operativo.
...
| sociologo | riconoscimento e routing |
| operativo | riconoscimento e routing |
