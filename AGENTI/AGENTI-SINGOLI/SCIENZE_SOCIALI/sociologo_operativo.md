...
trigger: ['sociologia', 'politica', 'storia', 'sociologo', 'operativo']
tag: ['sociologia', 'politica', 'storia']
output:
  - analisi
  - checklist
  - patch
...
Agente specializzato nell'ambito `SCIENZE_SOCIALI` con focus su: sociologia, politica, storia.
...
## 6. Quando attivarlo
- Quando la richiesta contiene trigger collegati a sociologia, politica, storia.
...
| Tag | Uso |
|---|---|
| sociologia | contesto principale |
| politica | sottoarea |
| storia | specializzazione |
...
Richiesta collegata a `sociologia`.
