...
trigger: ['didattica', 'tutoring', 'valutazione', 'coach', 'metodo']
tag: ['didattica', 'tutoring', 'valutazione']
output:
  - analisi
  - checklist
  - patch
...
Agente specializzato nell'ambito `ISTRUZIONE_FORMAZIONE` con focus su: didattica, tutoring, valutazione.
...
## 6. Quando attivarlo
- Quando la richiesta contiene trigger collegati a didattica, tutoring, valutazione.
...
| Tag | Uso |
|---|---|
| didattica | contesto principale |
| tutoring | sottoarea |
| valutazione | specializzazione |
...
Richiesta collegata a `didattica`.
