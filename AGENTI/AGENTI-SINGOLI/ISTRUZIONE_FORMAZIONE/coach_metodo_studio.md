---
id_agente: coach_metodo_studio
nome: Coach Metodo Studio
professione: Coach Metodo Studio
...
trigger: ['tutoring', 'progettazione_corsi', 'valutazione', 'coach', 'metodo']
tag: ['tutoring', 'progettazione_corsi', 'valutazione', 'coach', 'metodo']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: tutoring, progettazione_corsi, valutazione, coach, metodo.
- Quando serve competenza da Coach Metodo Studio.
...
| coach | riconoscimento e routing |
| metodo | riconoscimento e routing |
