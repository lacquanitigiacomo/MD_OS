---
id_agente: tutor_didattico
nome: Tutor Didattico
professione: Tutor Didattico
...
trigger: ['tutoring', 'progettazione_corsi', 'valutazione', 'tutor', 'didattico']
tag: ['tutoring', 'progettazione_corsi', 'valutazione', 'tutor', 'didattico']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: tutoring, progettazione_corsi, valutazione, tutor, didattico.
- Quando serve competenza da Tutor Didattico.
...
| tutor | riconoscimento e routing |
| didattico | riconoscimento e routing |
