---
id_agente: progettista_corsi
nome: Progettista Corsi
professione: Progettista Corsi
...
trigger: ['tutoring', 'progettazione_corsi', 'valutazione', 'progettista', 'corsi']
tag: ['tutoring', 'progettazione_corsi', 'valutazione', 'progettista', 'corsi']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: tutoring, progettazione_corsi, valutazione, progettista, corsi.
- Quando serve competenza da Progettista Corsi.
...
| progettista | riconoscimento e routing |
| corsi | riconoscimento e routing |
