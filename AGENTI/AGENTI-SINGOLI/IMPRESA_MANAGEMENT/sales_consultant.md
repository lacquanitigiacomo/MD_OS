...
trigger: ['project_management', 'strategia_business', 'operations', 'sales', 'consultant']
tag: ['project_management', 'strategia_business', 'operations', 'sales', 'consultant']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: project_management, strategia_business, operations, sales, consultant.
...
| sales | riconoscimento e routing |
| consultant | riconoscimento e routing |
