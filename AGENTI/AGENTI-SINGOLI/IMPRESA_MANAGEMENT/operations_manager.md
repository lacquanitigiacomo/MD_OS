...
trigger: ['project_management', 'strategia_business', 'operations', 'operations', 'manager']
tag: ['project_management', 'strategia_business', 'operations', 'operations', 'manager']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: project_management, strategia_business, operations, operations, manager.
- Quando serve competenza da Operations Manager.
