---
id_agente: process_designer
nome: Process Designer
professione: Process Designer
...
trigger: ['project_management', 'strategia_business', 'operations', 'process', 'designer']
tag: ['project_management', 'strategia_business', 'operations', 'process', 'designer']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: project_management, strategia_business, operations, process, designer.
- Quando serve competenza da Process Designer.
...
| process | riconoscimento e routing |
| designer | riconoscimento e routing |
