...
trigger: ['project_management', 'strategia_business', 'operations', 'project', 'manager']
tag: ['project_management', 'strategia_business', 'operations', 'project', 'manager']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: project_management, strategia_business, operations, project, manager.
- Quando serve competenza da Project Manager.
...
| project | riconoscimento e routing |
