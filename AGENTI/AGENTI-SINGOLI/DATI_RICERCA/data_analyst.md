...
trigger: ['analisi_dati', 'statistica', 'ricerca_documentale', 'data', 'analyst']
tag: ['analisi_dati', 'statistica', 'ricerca_documentale', 'data', 'analyst']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: analisi_dati, statistica, ricerca_documentale, data, analyst.
- Quando serve competenza da Data Analyst.
...
| analyst | riconoscimento e routing |
