---
id_agente: visual_data_designer
nome: Visual Data Designer
professione: Visual Data Designer
...
trigger: ['analisi_dati', 'statistica', 'ricerca_documentale', 'visual', 'data']
tag: ['analisi_dati', 'statistica', 'ricerca_documentale', 'visual', 'data']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: analisi_dati, statistica, ricerca_documentale, visual, data.
- Quando serve competenza da Visual Data Designer.
...
| visual | riconoscimento e routing |
| data | riconoscimento e routing |
