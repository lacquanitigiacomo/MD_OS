...
trigger: ['analisi_dati', 'statistica', 'ricerca_documentale', 'statistico']
tag: ['analisi_dati', 'statistica', 'ricerca_documentale', 'statistico']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: analisi_dati, statistica, ricerca_documentale, statistico.
- Quando serve competenza da Statistico.
...
| statistico | riconoscimento e routing |
