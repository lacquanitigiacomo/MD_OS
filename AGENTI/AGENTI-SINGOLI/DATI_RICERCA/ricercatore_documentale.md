...
trigger: ['analisi_dati', 'statistica', 'ricerca', 'ricercatore', 'documentale']
tag: ['analisi_dati', 'statistica', 'ricerca']
output:
  - analisi
  - checklist
  - patch
...
Agente specializzato nell'ambito `DATI_RICERCA` con focus su: analisi_dati, statistica, ricerca.
...
## 6. Quando attivarlo
- Quando la richiesta contiene trigger collegati a analisi_dati, statistica, ricerca.
...
| Tag | Uso |
|---|---|
| analisi_dati | contesto principale |
| statistica | sottoarea |
...
Richiesta collegata a `analisi_dati`.
