...
tag: ['sviluppo_web', 'frontend_ui', 'backend_api', 'senior', 'frontend']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: sviluppo_web, frontend_ui, backend_api, senior, frontend.
...
| senior | riconoscimento e routing |
| frontend | riconoscimento e routing |
