...
trigger: ['sviluppo_web', 'frontend_ui', 'backend_api', 'cloud', 'architect']
tag: ['sviluppo_web', 'frontend_ui', 'backend_api', 'cloud', 'architect']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: sviluppo_web, frontend_ui, backend_api, cloud, architect.
- Quando serve competenza da Cloud Architect.
...
| cloud | riconoscimento e routing |
