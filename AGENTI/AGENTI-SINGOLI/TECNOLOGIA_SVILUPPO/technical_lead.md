...
tag: ['sviluppo_web', 'frontend_ui', 'backend_api', 'technical', 'lead']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: sviluppo_web, frontend_ui, backend_api, technical, lead.
...
| technical | riconoscimento e routing |
| lead | riconoscimento e routing |
