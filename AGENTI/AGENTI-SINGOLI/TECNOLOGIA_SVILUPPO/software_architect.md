...
tag: ['sviluppo_web', 'frontend_ui', 'backend_api', 'software', 'architect']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: sviluppo_web, frontend_ui, backend_api, software, architect.
...
| software | riconoscimento e routing |
