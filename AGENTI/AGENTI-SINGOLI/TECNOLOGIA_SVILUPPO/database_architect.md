...
tag: ['sviluppo_web', 'frontend_ui', 'backend_api', 'database', 'architect']
output:
  - analisi
  - checklist
  - piano_operativo
...
## 6. Quando attivarlo
- Quando la richiesta contiene: sviluppo_web, frontend_ui, backend_api, database, architect.
...
| database | riconoscimento e routing |
