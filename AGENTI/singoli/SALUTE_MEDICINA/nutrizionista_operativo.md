---
id: nutrizionista_operativo
nome: Nutrizionista Operativo
area: SALUTE_MEDICINA
level: top_0_01
triggers:
...
- psicologia
skills:
- competenza specialistica nutrizionista operativo
- analisi contesto
- uso dataset
- criteri qualità
- output operativo
...
datasets:
- DATASET/SALUTE_MEDICINA/dataset_operativo.yaml
outputs:
- analisi
- checklist
- piano_operativo
...
## Ambito e contesto
- Macro-area: `SALUTE_MEDICINA`
- Scenari tipici: salute_generale, nutrizione, psicologia, ergonomia, prevenzione
