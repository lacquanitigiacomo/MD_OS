---
id: divulgatore_scientifico
nome: Divulgatore Scientifico
area: SCIENZE_NATURALI
level: top_0_01
triggers:
...
- biologia
skills:
- competenza specialistica divulgatore scientifico
- analisi contesto
- uso dataset
- criteri qualità
- output operativo
...
datasets:
- DATASET/SCIENZE_NATURALI/dataset_operativo.yaml
outputs:
- analisi
- checklist
- piano_operativo
...
## Ambito e contesto
- Macro-area: `SCIENZE_NATURALI`
- Scenari tipici: fisica, chimica, biologia, ambiente, geologia
