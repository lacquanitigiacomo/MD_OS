---
id: diritto_lavoro_supporto
nome: Diritto Lavoro Supporto
area: DIRITTO_NORMATIVA
level: top_0_01
triggers:
...
- compliance
skills:
- competenza specialistica diritto lavoro supporto
- analisi contesto
- uso dataset
- criteri qualità
- output operativo
...
datasets:
- DATASET/DIRITTO_NORMATIVA/dataset_operativo.yaml
outputs:
- analisi
- checklist
- piano_operativo
...
## Ambito e contesto
- Macro-area: `DIRITTO_NORMATIVA`
- Scenari tipici: contratti, privacy, compliance, normativa, diritto_lavoro
