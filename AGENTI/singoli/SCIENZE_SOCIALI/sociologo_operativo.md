---
id: sociologo_operativo
nome: Sociologo Operativo
area: SCIENZE_SOCIALI
level: top_0_01
triggers:
- sociologo operativo
- sociologia
...
- politica
skills:
- competenza specialistica sociologo operativo
- analisi contesto
- uso dataset
- criteri qualità
- output operativo
...
datasets:
- DATASET/SCIENZE_SOCIALI/dataset_operativo.yaml
outputs:
- analisi
- checklist
- piano_operativo
...
## Ambito e contesto
- Macro-area: `SCIENZE_SOCIALI`
- Scenari tipici: sociologia, storia, politica, antropologia, societa
