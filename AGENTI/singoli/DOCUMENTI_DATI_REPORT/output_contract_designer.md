---
id: output_contract_designer
nome: Output Contract Designer
area: DOCUMENTI_DATI_REPORT
level: top_0_01
triggers:
- output contract designer
- estrazione
- normalizzazione
- reportistica
skills:
- competenza specialistica output contract designer
- analisi contesto
- uso dataset
- criteri qualità
- output operativo
...
datasets:
- DATASET/DOCUMENTI_DATI_REPORT/dataset_operativo.yaml
outputs:
- analisi
- checklist
- piano_operativo
...
peso_token: medio
---
# Agente — Output Contract Designer
...
## Ambito e contesto
- Macro-area: `DOCUMENTI_DATI_REPORT`
- Scenari tipici: estrazione, normalizzazione, reportistica, revisione_documentale, tabelle
