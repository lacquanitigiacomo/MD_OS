...
- storytelling
skills:
- competenza specialistica analista filosofico
- analisi contesto
- uso dataset
- criteri qualità
- output operativo
...
datasets:
- DATASET/ARTI_CULTURA/dataset_operativo.yaml
outputs:
- analisi
- checklist
- piano_operativo
...
## Ambito e contesto
- Macro-area: `ARTI_CULTURA`
- Scenari tipici: scrittura, critica, storytelling, filosofia, letteratura
